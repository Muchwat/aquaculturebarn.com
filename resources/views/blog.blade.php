    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">{{ __('articles.page_title') }}</h1>
                <a href="{{ url('/') }}">{{ __('articles.home') }}</a>
                <i class="bi bi-arrow-right text-primary me-2"></i>
                <a href="{{ url('/articles') }}">{{ __('articles.page_breadcrumb') }}</a>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
                                ...
                                <div class="bg-secondary d-flex">
                                    ...
                                    <div class="d-flex flex-column justify-content-center py-3 px-4">
                                        <div class="d-flex mb-2">
                                            ...
                                            <small class="text-uppercase me-3"><i class="bi bi-bookmarks me-2"></i>{{$article->category->name}}</small>
                                        </div>
                                        <a class="h4" href='{{ url("/articles/$article->slug") }}'>{{ Str::limit($article->title, 35, '...') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mb-5">
                    ...
                    @foreach ($recents as $recent)
                        <div class="d-flex mb-3">
                            ...
                            <a href='{{ url("/articles/$recent->slug") }}'
